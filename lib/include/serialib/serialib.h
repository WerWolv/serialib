...
public:
    ...
    // Open a device
    char openDevice(const char *portName, unsigned int Bauds,
    ...
    int     readChar    (char *pByte, unsigned int timeOut_ms = 0);
    ...
    int     readBytes   (void *buffer, unsigned int maxNbBytes, unsigned int timeOut_ms = 0, unsigned int sleepDuration_us = 100);
